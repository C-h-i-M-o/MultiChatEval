...
- 评分详情弹窗展示规则分、LLM Judge 分、基础分、反馈分、最终分、命中项、评审理由、用户反馈摘要和公开评论。
- 支持分页查看、发布和删除公开评论。
...
- 保留 `/feedback` 路由和占位页面，便于后续继续开发。
- demo-v1 侧边栏不展示反馈统计入口。
